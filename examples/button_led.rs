...
use stm32f4_discovery::stm32f4xx_hal::delay::Delay;
use stm32f4_discovery::stm32f4xx_hal::prelude::*;
use stm32f4_discovery::stm32f4xx_hal::pac;

use stm32f4_discovery::button::UserButton;
use stm32f4_discovery::leds::Leds;
use stm32f4_discovery::switch_hal::{InputSwitch, OutputSwitch};
